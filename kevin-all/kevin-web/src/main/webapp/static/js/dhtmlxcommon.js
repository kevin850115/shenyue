...
dtmlXMLLoaderObject.prototype.waitLoadFunction = function(dhtmlObject) {
    ...
    this.check = function() {
        if ((dhtmlObject) && (dhtmlObject.onloadAction != null)) {
            if (((!dhtmlObject.xmlDoc.readyState) || (dhtmlObject.xmlDoc.readyState == 4)) && ((dhtmlObject.xmlDoc.status >= 200 && dhtmlObject.xmlDoc.status < 300) || dhtmlObject.xmlDoc.status == 304)) {
                if (!once)
                    return;
                once = false;
